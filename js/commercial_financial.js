    ...
    if (has.showStaticWelcomeMessage) {
      ...
      if (summaryEl) summaryEl.innerHTML = `
        <div class="welcome-message-static">
          ...
          <p class="muted" style="white-space:pre-line">to Finco Capital. Please select your loan type and purpose to get started.</p></h2>
        </div>
      `;
    }
...
Figures are preliminary and for guidance. For a detailed assessment, please request a call-back.`;
  ...
  function writeResults(header, html, detailsTitle, detailsHtml, disclaimerText) {
    ...
    if (resEl) {
      ...
      // Create CTA button with email functionality
      const ctaBtn = document.createElement('button');
      ctaBtn.type = 'button';
      ctaBtn.className = 'cta-btn btn-consultation';
      ctaBtn.dataset.action = 'consultation';
      ctaBtn.innerHTML = `<img src="./t-removebg-preview.png" alt="" style="width:10px; height:16px; vertical-align:middle;"> Submit a Call Back Request`;

...
function repairFile(filePath) {
    try {
        ...
        // Check if file has full DOCTYPE and structure
        ...
        content = content.replace(/<div class="commercial-page-container"[^>]*>/g, '');
        content = content.replace(/<div class="top-image-wrapper">[^<]*<img[^>]*>[^<]*<\/div>/g, '');
